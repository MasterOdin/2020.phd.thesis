...
\centering
    \hfill
    \subfigure[Storyline Viewer]{\includegraphics[width=0.3\columnwidth]{chapters/03_muifold/figures/storyline_viewer.png}}
    \hfill
    \subfigure[Article Viewer]{\includegraphics[width=0.25\columnwidth]{chapters/03_muifold/figures/article_viewer.png}}
    \hfill
    \\
    \hfill
    \subfigure[Scenario Generation Tool]{\includegraphics[width=0.4\columnwidth]{chapters/03_muifold/figures/scenario_planner.png}}
    \hfill
    \subfigure[Generated Scenario  Logic Map]{\includegraphics[width=0.4\columnwidth]{chapters/03_muifold/figures/scenario_planner_map.png}}
    \hfill
...
\centering
    \hfill
    \subfigure[]{\includegraphics[width=0.5\columnwidth]{chapters/03_muifold/figures/hypthosis_generator.png}}
    \hfill
    \subfigure[]{\includegraphics[width=0.25\columnwidth]{chapters/03_muifold/figures/hypthosis_muifold.png}}
    \hfill
